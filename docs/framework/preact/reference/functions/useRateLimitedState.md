...
Defined in: [preact-pacer/src/rate-limiter/useRateLimitedState.ts:108](https://github.com/dogmar/pacer/blob/main/packages/preact-pacer/src/rate-limiter/useRateLimitedState.ts#L108)
...
\[`TValue`, `Dispatch`\<`StateUpdater`\<`TValue`\>\>, [`PreactRateLimiter`](../interfaces/PreactRateLimiter.md)\<`Dispatch`\<`StateUpdater`\<`TValue`\>\>, `TSelected`\>\]
