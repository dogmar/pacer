...
For more direct control over rate limiting behavior without Preact state management,
...
\[`TValue`, [`PreactRateLimiter`](../interfaces/PreactRateLimiter.md)\<`Dispatch`\<`StateUpdater`\<`TValue`\>\>, `TSelected`\>\]
