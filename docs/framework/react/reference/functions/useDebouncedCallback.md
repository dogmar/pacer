...
Defined in: [react-pacer/src/debouncer/useDebouncedCallback.ts:42](https://github.com/dogmar/pacer/blob/main/packages/react-pacer/src/debouncer/useDebouncedCallback.ts#L42)
...
[`ReactDebouncerOptions`](../interfaces/ReactDebouncerOptions.md)\<`TFn`, \{
\}\>
