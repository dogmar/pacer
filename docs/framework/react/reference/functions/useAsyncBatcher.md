...
Defined in: [react-pacer/src/async-batcher/useAsyncBatcher.ts:235](https://github.com/dogmar/pacer/blob/main/packages/react-pacer/src/async-batcher/useAsyncBatcher.ts#L235)
