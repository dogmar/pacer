...
Defined in: [preact-pacer/src/queuer/useQueuer.ts:194](https://github.com/dogmar/pacer/blob/main/packages/preact-pacer/src/queuer/useQueuer.ts#L194)
...
[`PreactQueuer`](../interfaces/PreactQueuer.md)\<`TValue`, `TSelected`\>
