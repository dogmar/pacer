...
Defined in: [preact-pacer/src/throttler/useThrottler.ts:168](https://github.com/dogmar/pacer/blob/main/packages/preact-pacer/src/throttler/useThrottler.ts#L168)
...
[`PreactThrottler`](../interfaces/PreactThrottler.md)\<`TFn`, `TSelected`\>
