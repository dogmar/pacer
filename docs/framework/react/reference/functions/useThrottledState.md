...
Defined in: [react-pacer/src/throttler/useThrottledState.ts:90](https://github.com/dogmar/pacer/blob/main/packages/react-pacer/src/throttler/useThrottledState.ts#L90)
