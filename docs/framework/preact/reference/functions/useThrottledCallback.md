...
Defined in: [preact-pacer/src/throttler/useThrottledCallback.ts:43](https://github.com/dogmar/pacer/blob/main/packages/preact-pacer/src/throttler/useThrottledCallback.ts#L43)
